...
import com.petshop.model.dao.MascotaFacade;
...
public class MascotaController implements Serializable {
    ...
    @EJB
    private com.petshop.model.dao.MascotaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("MascotaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("MascotaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("MascotaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
