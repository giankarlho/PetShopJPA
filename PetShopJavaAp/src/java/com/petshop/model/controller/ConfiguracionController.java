...
import com.petshop.model.dao.ConfiguracionFacade;
...
public class ConfiguracionController implements Serializable {
    ...
    @EJB
    private com.petshop.model.dao.ConfiguracionFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("ConfiguracionCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("ConfiguracionUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("ConfiguracionDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Configuracion getConfiguracion(java.lang.String id) {
